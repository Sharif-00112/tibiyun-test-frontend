...
const WholeMenu = () => {
    ...
    const handleSearchSubmit = () => {
        ...
        // Send user data, search criteria, and results to your backend for storage
        const searchData = {
            user: user.email, // Assuming user.email is available
            searchCriteria: {
                searchCountry,
                searchFoodName,
                searchRestaurant,
        ...
        // Send searchData to your backend API or function
        // Example: fetch('/api/storeSearch', { method: 'POST', body: JSON.stringify(searchData) });
    };
                ...
                <Container>
                    ...
                    <ul>
                        {searchResults.map(item => (
                            <li key={item.ID}>{item.foodName} - {item.restaurantName}</li>
                        ))}
                    </ul>
                </Container>
            )}
