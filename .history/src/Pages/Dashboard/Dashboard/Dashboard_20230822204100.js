                ...
                <Table sx={{ minWidth: 550 }} aria-label="Search History table">
                    ...
                    {searchHistories.map((row) => (
                        ...
                        <TableCell component="th" scope="row">
                            ...
                            <TableCell align="center">{row.searchedBy.searchCountry}, {row.searchedBy.searchFoodName }, { row.searchedBy.searchRestaurant}, { row.searchedBy.searchMaxPrice}, {row.searchedBy.searchReservation }</TableCell>
