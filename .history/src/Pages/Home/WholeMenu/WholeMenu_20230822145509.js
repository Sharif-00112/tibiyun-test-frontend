...
const WholeMenu = () => {
    ...
    const sendSearchResultsToDatabase = (results) => {
        ...
        // You can use fetch or any other method to send data to your database
        // For example, you can send results to an API endpoint
        // Replace the following URL with your actual API endpoint
        const apiUrl = '/send-search-results';
        fetch(apiUrl, {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            console.log('Search results and additional data sent to the database:', data);
        })
        .catch(error => {
